  ...
  return (
    <section className="miolo-pets-namorando">
      ...
      <div className="publicidade animate-item">
        <img src="/images/publicidade.png" alt="Publicidade" />
      </div>
